...
| M2R 騎乘音訊 Preview | 已更新第 7 版，待手機驗收 | 95% | 需確認 iPhone Safari 提示音與英文語音實際有聲 |
| M2 快速預習 | 未開始 | 0% | 可使用人工單字與例句開發，不依賴 Gemini |
| M3 正式複習 | 未開始 | 0% | 等 M2 |
| M4 自適應排程 | 未開始 | 0% | 等 M3 |
...
- 在 iPhone Safari 依序測試第 7 版的「測試手機提示音」與「停妥後試聽」；先排查媒體音量、藍牙輸出與靜音，再依兩項實機結果決定是否改用非 Gemini 的替代音源。
