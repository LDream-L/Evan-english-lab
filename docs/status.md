...
| M2R 騎乘音訊 Preview | 已更新第 6 版，待手機驗收 | 95% | 需確認 iPhone Safari 實際有聲 |
...
- 2026-09-25：M2R 音訊修正已部署為第 6 版 `v0.2.3-m2r-audio`，沿用私人 Web App 原網址與「只有我自己」權限；新增停妥後試聽、實際起播狀態、8 秒未起播提示及語音錯誤訊息。線上驗證 112 字可建立 35 分鐘／177 次播放清單；雲端瀏覽器試聽回報 `synthesis-failed`，手機實際聲音待驗。

## 下一批

- 在 iPhone Safari 測試第 6 版的「停妥後試聽」及英／中語音；若顯示錯誤，依實機錯誤碼修正語音引擎或改用非 Gemini 的替代音源。
